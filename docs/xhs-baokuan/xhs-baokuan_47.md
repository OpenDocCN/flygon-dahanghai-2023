...
2 然后可以用后奕抓取工具打开智能模式就可以抓取

3 如果软件使用不明白的哈，我分享一个插件给大家，就是需要手动去滑就可以获取了  4.如果大家需要去提取笔记内容我这边有找到一个提取软件，你们把链接复制进去就可以批量提取笔记图片和文件了用的时候呢尽量去把杀毒软件关掉哈

链接放在下面了

【超级会员 V5】通过百度网盘分享的文件：小红书批量 PLU....exe 链接：

提取码：c6c9

复制这段内容打开「百度网盘 APP 即可获取」

【超级会员 V5】通过百度网盘分享的文件：链接批量提取插件
...
西哥 : 有做小红书的可以一起交流，正在学习阶段嘻嘻 DUM321➕备注生财哈  亿安 : 两个链接内容是一样的，都是 plus

西哥 : 【超级会员 V5】通过百度网盘分享的文件：链接批量提取插件

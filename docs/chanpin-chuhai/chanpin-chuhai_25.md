...
优化 Facebook 广告可以从广告数据里出发，点击少那说明广告素材有问题，不过直接抄对手的整合过是不会的，有点击量，在 pixel 里看 view content，如果内容没人看，那应该是落地页出现了问题。有 view Content 没人加入购物车，那可能是折扣价格等不足以让客户下单，这个要多对比下对手，给点折扣等。

...
# (精华帖)(605 赞)20 个步骤：再小的个体，也可以从 0 到 1，打造出你的个人品牌
...
于是，我给她出了一道思考题：如果定一个栏目，每天输出一段话或者一篇文章，连续输出 60 天，你准备做什么栏目？
...
以下 20 个步骤适用于从 0 到 1，高手可忽略。供星友们参考~
...
定位非常非常重要，所以放在第一条说。定位是 1，其他的事情都是后面的 0。
